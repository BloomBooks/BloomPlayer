...
if (process.env.npm_lifecycle_event == "build:prod") {
  module.exports = [
    merge(common_player_bits, production_bits),
    merge(common_page_player_bits, production_bits)
  ];
} else {
  module.exports = [
    merge(common_player_bits, dev_bits),
    merge(common_page_player_bits, dev_bits)
  ];
}
